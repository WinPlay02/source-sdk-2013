...
#endif //SecobMod__Enable_Fixed_Multiplayer_AI
{
	...
	/*#ifdef SecobMod__Enable_Fixed_Multiplayer_AI
	return BaseClass::WantsLagCompensationOnEntity( pEntity, pCmd, pEntityTransmitBits ); //Might have to check if we did some edits to the baseclass and put it here
	#endif //SecobMod__Enable_Fixed_Multiplayer_AI*/
